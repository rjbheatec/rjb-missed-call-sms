...
def webhook():
    ...
    # compose message
    message = (
        f"Hi, thanks for calling {brand['brand']}. "
        f"Sorry we missed you — we'll call back shortly. "
        f"You can also WhatsApp us on 0{WHATSAPP_NUMBER[2:]} "
        f"or book online at {brand['website']}"
    )
